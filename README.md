...
<p align="center">
  <b>Your wallet's AI concierge.</b>
</p>
...
- `receipt_butler_flutter`: The mobile application built with Flutter.
- `receipt_butler_server`: The backend server built with Serverpod.
- `receipt_butler_client`: The generated client library for communication between Flutter and Serverpod.
