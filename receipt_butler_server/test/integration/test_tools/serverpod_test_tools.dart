...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:receipt_butler_server/src/generated/classification/batch_classification_response.dart'
    as _i5;
import 'package:receipt_butler_server/src/generated/classification/classification_task.dart'
    as _i6;
import 'package:receipt_butler_server/src/generated/receipt.dart' as _i7;
import 'package:receipt_butler_server/src/generated/greetings/greeting.dart'
    as _i8;
import 'package:receipt_butler_server/src/generated/protocol.dart';
import 'package:receipt_butler_server/src/generated/endpoints.dart';
...
class _ClassificationEndpoint {
  _ClassificationEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<_i5.BatchClassificationResponse> classifyBatch(
    _i1.TestSessionBuilder sessionBuilder,
    List<_i6.ClassificationTask> tasks,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'classification',
          methodName: 'classifyBatch',
          parameters: _i1.testObjectToJson({'tasks': tasks}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i5.BatchClassificationResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
