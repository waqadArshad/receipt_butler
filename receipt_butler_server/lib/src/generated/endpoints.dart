...
import 'package:receipt_butler_server/src/generated/classification/classification_task.dart'
    as _i8;
import 'package:receipt_butler_server/src/generated/receipt.dart' as _i9;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'classification': _i4.ClassificationEndpoint()
        ..initialize(
          server,
          'classification',
          null,
    ...
    connectors['classification'] = _i1.EndpointConnector(
      name: 'classification',
      endpoint: endpoints['classification']!,
      methodConnectors: {
        'classifyBatch': _i1.MethodConnector(
          name: 'classifyBatch',
          params: {
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['classification'] as _i4.ClassificationEndpoint)
                      .classifyBatch(
                        session,
                        params['tasks'],
                      ),
